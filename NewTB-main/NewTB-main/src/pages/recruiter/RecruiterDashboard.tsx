...
const RecruiterDashboard = () => {
  ...
  const metrics = {
    activeDrives: stats?.totalDrives || 0,
    totalApplications: stats?.totalApplications || 0,
    shortlisted: stats?.shortlistedApplications || 0,
    interviewScheduled: stats?.interviewScheduledApplications || 0,
    accepted: stats?.acceptedApplications || 0,
    hired: stats?.selectedApplications || 0,
  };

  // Mock recent activities - in real app this would come from stats
