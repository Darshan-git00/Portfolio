        ...
        <div className="container mx-auto">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-8 tracking-tight leading-tight">
              <motion.span 
                className="block bg-gradient-to-r from-amber-300 via-orange-300 to-amber-300 bg-clip-text text-transparent drop-shadow-lg mt-8"
              ...
              <br />
              <motion.span 
                className="block bg-gradient-to-r from-orange-300 via-amber-300 to-orange-300 bg-clip-text text-transparent drop-shadow-lg"
                initial={{ opacity: 0, x: 50 }}
                animate={{ opacity: 1, x: 0 }}
            ...
            <motion.p 
              className="text-xl md:text-2xl text-white/80 font-light max-w-4xl mx-auto mb-20 leading-relaxed"
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.6, duration: 0.8 }}
            >
              Transform your career journey with cutting-edge AI interviews, intelligent matching algorithms, and seamless collaboration between students, colleges, and recruiters worldwide.
            </motion.p>
            ...
            >
              <Link to="/auth/student" className="block">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button 
                    size="lg" 
                    className="bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 hover:from-purple-700 hover:via-pink-700 hover:to-purple-700 text-white px-10 py-4 rounded-full text-lg font-bold shadow-2xl hover:shadow-purple-500/50 transition-all duration-300 relative overflow-hidden group"
                  >
                    <motion.div 
                    ...
                    <span className="relative z-10 flex items-center">
                      Get Started <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform duration-300" />
                    </span>
                  </Button>
                </motion.div>
              </Link>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button 
                  variant="outline" 
                  size="lg"
                  className="border-white/40 text-white bg-white/10 hover:bg-white/20 hover:border-white/60 px-10 py-4 rounded-full text-lg font-medium backdrop-blur-sm transition-all duration-300 group"
                  onClick={() => {
            ...
            {stats.map((stat, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-4xl font-bold text-white mb-2 group-hover:text-purple-200 transition-colors duration-300">{stat.value}</h3>
              ...
              return (
                ...
                >
                  <Link to={role.path} className="block group h-full">
                    <motion.div
                      className="relative h-[550px] rounded-3xl p-8 border border-white/10 overflow-hidden backdrop-blur-sm"
                      whileHover={{ 
                        scale: 1.05, 
                        y: -10,
                    ...
                    >
                      ...
                      <div className="relative z-10 h-full flex flex-col">
                        ...
                        <motion.div
                          className="w-24 h-24 bg-white/20 backdrop-blur-md rounded-3xl flex items-center justify-center mb-8 flex-shrink-0 shadow-xl"
                          whileHover={{ 
                            scale: 1.15, 
                            rotate: 15,
                        ...
                        {/* Title */}
                        <motion.h3 
                          className="text-4xl font-bold text-white mb-8 flex-shrink-0 group-hover:text-yellow-200 transition-colors duration-500"
                        ...
                        <div className="space-y-3 mb-8 flex-1">
                          {role.features.map((feature, idx) => (
                            <motion.div 
                              key={idx} 
                              className="flex items-center gap-3 text-white/70 text-sm group/item hover:text-white transition-colors duration-300"
                              initial={{ opacity: 0, x: -20 }}
                              animate={{ opacity: 1, x: 0 }}
            ...
            >
              ...
              <div className="relative z-10">
                <h2 className="text-5xl md:text-6xl font-bold text-white mb-6">
                  ...
                  <br />
                  <span className="bg-gradient-to-r from-pink-200 via-purple-200 to-white bg-clip-text text-transparent drop-shadow-lg">
                    Your Career?
                  </span>
                </h2>
                <p 
            ...
            >
              ...
              <div className="flex gap-4">
                {[Heart, Globe, MessageCircle].map((Icon, idx) => (
                  <motion.div
                    key={idx}
                    className="w-12 h-12 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 group"
                    whileHover={{ 
                      scale: 1.15, 
                      rotate: 15,
          ...
          >
            <p className="text-white/40 text-sm flex items-center justify-center gap-2">
              ...
              <motion.div
                ...
                transition={{ duration: 2, repeat: Infinity }}
              >
                <Heart className="w-4 h-4 inline text-red-500 mx-2" />
              </motion.div>
